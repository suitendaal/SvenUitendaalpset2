package com.example.svenu.svenuitendaalpset2;// !YOU MAY WANT TO CHANGE THE PACKAGE BELOW SO THAT IT MATCHES YOUR PROJECT'S PACKAGE!
...
public class Story implements Serializable {
    ...
    /** constructs a new com.example.svenu.svenuitendaalpset2.Story reading its text from the given input stream */
